const ReputationTrackerABI = [
  ...
  },
  {
    ...
    name: "getHoursRemainingForStreak",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    inputs: [
      {
        internalType: "address",
        name: "newTaskVerificationAddress",
        type: "address",
      },
    ],
